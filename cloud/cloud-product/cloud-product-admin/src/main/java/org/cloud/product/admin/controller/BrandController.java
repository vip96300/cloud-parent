...
public class BrandController {
	...
	@ApiImplicitParams({@ApiImplicitParam(name="braid",value="品牌编号",required=true,dataType="long")})
	@RequestMapping(value="/del_braid",method={RequestMethod.GET})
	...
	@ApiOperation(value="根据品牌编号删除品牌")
	@ApiImplicitParams({@ApiImplicitParam(name="braid",value="品牌编号",required=true,dataType="long")})
	@RequestMapping(value="/upd_braid",method=RequestMethod.GET)
	public void upd_braid(@RequestParam(value="braid",required=true)long braid){
		Brand brand=brandService.getByBraid(braid);
