...
import org.cloud.packet.client.service.breaker.PictureServiceBreaker;
...
public interface PictureService {
	...
	public List<Picture> listByProids(@RequestParam(value="proids",required=true)List<Long> proids);
	/**
	 * 根据图片类型和产品编号集合获取图片列表
	 * @param proids
	 * @return
	...
	public List<Picture> listByTypeProids(@RequestParam(value="type",required=true)int type,@RequestParam(value="proids",required=true)List<Long> proids);
